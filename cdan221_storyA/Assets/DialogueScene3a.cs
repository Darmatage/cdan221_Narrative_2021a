...
public void talking(){         // main story function. Players hit next to progress to next int
        ...
        if (primeInt == 1){
			   ...
			   ArtChar2.SetActive(false);
                ...
                Char1name.text = "YOU";
                Char1speech.text = "Wow, this garden is really pretty.";
                Char2name.text = "";
                Char2speech.text = "";
        }
       else if (primeInt ==3){
			ArtChar1.SetActive(true);
			 ...
			 // Turn off "Next" button, turn on "Choice" buttons
                ...
                allowSpace = false;
                Choice1a.SetActive(true); // function Choice1aFunct() I've never met an ogre.
                Choice1b.SetActive(true); // function Choice1bFunct() That ogre looks scary.
        }
       else if (primeInt == 6){
                Char1name.text = "Jeda";
...
// FUNCTIONS FOR BUTTONS TO ACCESS (Choice #1 and switch scenes)
        public void Choice1aFunct(){
                Char1name.text = "YOU";
                Char1speech.text = "I think I'll say hi.";
                Char2name.text = "";
                Char2speech.text = "";
                primeInt = 99;
                Choice1a.SetActive(false);
        ...
        public void Choice1bFunct(){
                Char1name.text = "YOU";
                Char1speech.text = "I think I'll keep my distance.";
                Char2name.text = "";
                Char2speech.text = "";
                primeInt = 199;
                Choice1a.SetActive(false);
